...
class RagAgent:
    def __init__(self, k: int = 5, max_iters: int = 4) -> None:
    ...
    def ask(self, question: str) -> AgentResult:
        ...
        for _ in range(self._max_iters):
            ...
            if not tool_calls:
                ...
                return AgentResult(answer=answer, sources=sources, refused=False, trace=trace)
            messages.append(ai)
        ...
        return AgentResult(answer=REFUSAL_MESSAGE, sources=[], refused=True, trace=trace)
